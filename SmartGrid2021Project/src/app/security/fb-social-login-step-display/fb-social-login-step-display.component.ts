...
import { SocialLoginStepDisplayComponent } from '../social-login-step-display/social-login-step-display.component';

@Component({
  selector: 'app-fb-social-login-step-display',
  templateUrl: './fb-social-login-step-display.component.html',
  styleUrls: ['./fb-social-login-step-display.component.css']
})
export class FbSocialLoginStepDisplayComponent implements OnInit {
