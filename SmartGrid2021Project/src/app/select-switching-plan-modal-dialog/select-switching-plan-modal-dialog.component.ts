...
@Component({
  selector: 'app-select-switching-plan-modal-dialog',
  templateUrl: './select-switching-plan-modal-dialog.component.html',
  styleUrls: ['./select-switching-plan-modal-dialog.component.css']
})
export class SelectSwitchingPlanModalDialogComponent implements OnInit {
  toggleAll: boolean;
  toggleMine: boolean;
  clickedRow:SwitchingPlan;
  ...
  responseData : any[];
  constructor(private SwitchingPlanService: SwitchingPlanService,private dialogRef: MatDialogRef<SelectSwitchingPlanModalDialogComponent>) { }
